...
not wrap this in `paper-wobble` — that would shake it twice. `maxTilt={0}` sits
the chip square if you want a deliberately tidy row.
...
<PropsTable
  rows={[
    ...
    },
    {
      ...
      type: "number",
      default: "2.6",
      description: "Largest hand-placed tilt in degrees; 0 sits square",
    },
    {
      name: "step",
      type: "number",
