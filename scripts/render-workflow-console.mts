...
const temp = mkdtempSync(path.join(tmpdir(), "remocn-workflow-console-"));
const output = path.resolve("out/workflow-console.mp4");
...
try {
  ...
  run("bunx", [
    "remotion",
    "render",
    "src/remotion/workflow-console-root.tsx",
    "WorkflowConsole",
    picture,
    "--codec=h264",
    "--crf=17",
